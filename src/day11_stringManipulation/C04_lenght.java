...
public class C04_lenght {
    public static void main(String[] args) {
        //kullanıcıdan ismini alıp basharfini ve son harfini Buyuk harflerle yazdırın

        Scanner scan= new Scanner (System.in);
        System.out.println("lütfe isminizi giriniz");
        ...
        //String str2=null;
        //System.out.println(str2.length());// calıstırıldığında hata verir
        //String str3;
