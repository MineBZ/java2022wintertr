...
public class C05_indexOf {
    public static void main(String[] args) {
        ...
        //istersek char olarak verdigımız bir harfin indexini bize  döndürür
        System.out.println(str1.indexOf("J"));//0

        //İSTERSEK BİR HARF YADA metin olarak verdiğimiz string'in indexini bize döndürür
        ...
        System.out.println(str1.indexOf('b'));//5 bulduğu ilk doğu eşeleşmenin indexini döndürür

        //
        System.out.println(str1.indexOf('b', 5));
        //bu methodda java aramaya fromIndex olarak yazdığımız indexten baslar
